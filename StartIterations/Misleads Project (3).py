...
while color1 != 'blue' and 'green' and 'white' and 'black':
        color2 = input("choose a color from the list")
        if color2 == 'blue' or 'green' or ' white' or 'black':
                color1 = color2
                break
#################
#Equipment Debug#
#################
equipment = input("What kind of extra equipment would you like to carry into the dungeon?\n\n1)Sword(strength)\n2)Bag(space)\n3)Flashlight(luck)\n\n")
while equipment != ('sword') or equipment != ('bag') or equipment != ('flashlight'):
        equipment = input("Choose an Appropriate Equipment: ")
